...
test.describe('End-to-End User Workflows', () => {
  ...
  test('should complete data submission and retrieval workflow', async ({
    page,
  }) => {
    const authPage = new AuthPage(page)
  ...
  test('should complete data submission and blockchain verification workflow', async ({
    page,
  }) => {
    const authPage = new AuthPage(page)
    const submitPage = new SubmitDataPage(page)
  ...
  test('should handle session expiry and re-authentication workflow', async ({
    page,
  }) => {
    const authPage = new AuthPage(page)
    const dashboardPage = new DashboardPage(page)
  ...
  test('should handle multiple data submissions with different collections', async ({
    page,
  }) => {
    const authPage = new AuthPage(page)
    const submitPage = new SubmitDataPage(page)
