...
test.describe('Blockchain Explorer', () => {
  ...
  test('should display block details when selected', async ({
    authenticatedPage,
  }) => {
  ...
  test('should show previous hash for non-genesis blocks', async ({
    authenticatedPage,
  }) => {
    await explorerPage.waitForPageLoad()
  ...
  test('should display transactions in block', async ({
    authenticatedPage,
  }) => {
  ...
  test('should display Merkle tree visualization', async ({
    authenticatedPage,
  }) => {
    await explorerPage.waitForPageLoad()
    await explorerPage.selectBlock(0)
  ...
  test('should update when new blocks are created', async ({
    authenticatedPage,
  }) => {
    await explorerPage.waitForPageLoad()
