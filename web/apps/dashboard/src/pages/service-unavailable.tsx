        ...
        <Stack spacing={8}>
            ...
            <CardContent>
              <Stack spacing={6}>
                <Stack spacing={4}>
                  ...
                  <Text color="zinc-400">
                    The Goud Chain service is temporarily unavailable due to
                    high load or ongoing maintenance. Your data is safe and the
                    blockchain continues to operate.
                  </Text>
                </Stack>

                <Stack spacing={4}>
                  <Heading level={3}>What can you do?</Heading>
                  <Stack spacing={3}>
                    <Text color="zinc-400">
          ...
          <Stack align="center">
            <Text size="sm" color="zinc-500">
              Technical details: Service returned a 5xx error indicating
              server-side issues.
            </Text>
          </Stack>
        </Stack>
